export default function JonRheaumeSite() {
  ...
  const buildCards = [
    ...
    },
    {
      ...
      body:
        "Signal processing, sequencing logic, and execution design that define how pipeline is created, routed, and converted. Includes where AI improves throughput and where it degrades signal.",
    },
  ];

  const workItems = [
  {
    title: "ClearCompany | $11M → $88M ARR",
    summary:
    ...
    bullets: [
      "Reduced SDR ramp by 66% (90 to 30 days) and improved lead-to-opportunity conversion (24% to 48%)",
      "Architected a $400M+ cumulative pipeline engine; scaled SDR org from 0 to 40+ reps",
  ...
  },
  {
    ...
    summary:
      "Developed an outbound system to identify in-market buyers prior to inbound conversion. Focused on motion design, defining the handoff between AI automation and human execution to increase deal velocity.",
    bullets: [
          ...
          <div className="mx-auto grid max-w-6xl gap-10 px-6 py-24 lg:grid-cols-[1.2fr_0.8fr] lg:px-8 lg:py-32">
            ...
            <div className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
              ...
              <div className="mt-4 space-y-5 text-sm leading-7 text-slate-700">
                <p>
                  Revenue infrastructure for B2B SaaS companies where the real constraint is not effort. It is whether pipeline, capacity, and conversion math actually hold up.
                </p>
                <p>
                  Best aligned to senior operating roles, revenue-modeling projects, and selective fractional work where leadership wants math and systems, not GTM hype.
                </p>
              </div>
            </div>
        ...
        <section id="build" className="bg-[#f3efe7]">
          ...
          <div className="mb-10">
            ...
            <h2 className="mt-3 max-w-3xl text-3xl font-medium tracking-tight text-[#00354B] md:text-4xl">
              <span className="font-serif">Revenue outcomes are driven by how pipeline is created, how teams are deployed, and how conversion happens over time.</span>
            </h2>
          </div>
          ...
          <div className="mx-auto max-w-6xl px-6 py-20 lg:px-8">
            <div className="mb-10">
              ...
              <p className="mt-4 text-sm text-slate-600">
                Detailed case studies and system walkthroughs are available upon request.
              </p>
            </div>
